            ...
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li class="active">
                            <a href="customerEntry.action?cityId=2">用户首页</a>
                        </li>
                    </ul>
                    <%-- 右边题头--%>
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active">
                            <a class="btn-default" href="showAllOrderProduct.action">查看我的订单记录</a>
                        </li>

                        <li class="active">
                            <a class="btn-default" href="showUserInfo.action">查看我的信息</a>
                        </li>
